...
import { useAbonarFichasVigentesCreditoMutation } from '../../creditos/hooks/creditosHooks';
import { ClienteCard } from '../components/ClienteCard';
import { ClienteModal, type ClienteDraft } from '../components/ClienteModal';
...
import { obtenerCreditosDeCliente, obtenerCreditoPorId } from '../../api';
...
const Clientes = () => {
  ...
  const creditosClienteQuery = useQuery({
    ...
    queryFn: () => obtenerCreditosDeCliente(clienteSeleccionado?.id as string),
  ...
  const creditoPagoDetalleQuery = useQuery({
    ...
    queryFn: () => obtenerCreditoPorId(creditoPagoSeleccionado?.id as string),

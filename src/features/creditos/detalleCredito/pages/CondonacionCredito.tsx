...
import { numberInputDisplay, parseNumberInput } from '../../../../shared/utils/numberInput';
import { useCondonacionCreditoPage } from '../hooks/useCondonacionCreditoPage';
                ...
                <div>
                  ...
                  <div className="relative max-w-2xl">
                    ...
                    <input
                      ...
                      step="0.01"
                      className="form-input pl-8 text-lg font-semibold tabular-nums lg:text-xl"
                      placeholder="0.00"
